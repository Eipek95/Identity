namespace AspNetCoreIdentityApp.Core.PermissionsRoot
{
    public static class Permissions
    {
        public static class Stock
        {
            ...
            public const string Write = "Permissions.Stock.Create";
        ...
        public static class Order
        {
            ...
            public const string Write = "Permissions.Order.Create";
        ...
        public static class Catalog
        {
            ...
            public const string Write = "Permissions.Catalog.Create";
